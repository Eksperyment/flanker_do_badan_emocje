...
<div id="flanker-task">
    ...
    <div id="instruction-screen">
        ...
        <p>
        Jeżeli środkowa strzałka wskazuje w lewo —
        naciśnij klawisz <b>A</b>.
        </p>

        <p>
        Jeżeli środkowa strzałka wskazuje w prawo —
        naciśnij klawisz <b>L</b>.
        </p>
        ...
        <input
            type="text"
            id="participant-id"
            placeholder="Wpisz numer osoby badanej"
        >
...
emailjs.init({
    publicKey: 'm8HODmJkP33wKFLpw'
});

const SERVICE_ID = 'service_g0fmzvh';

const TEMPLATE_ID = 'template_7iz1vj8';

const RECEIVER_EMAIL =
'eksperyment.emocje.ip.umcs@gmail.com';
